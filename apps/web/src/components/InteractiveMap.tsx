...
import { Button, Card } from '@beactive/ui';
import { MOCK_ACTIVITIES, Activity, ACTIVITY_CATEGORIES } from '@beactive/shared';
...
export default function InteractiveMap({ onActivitySelect }: InteractiveMapProps) {
  ...
  const filteredActivities = MOCK_ACTIVITIES.filter(
    activity => activity.category.id === selectedCategory
  );
  ...
  return (
    <div className="w-full">
      ...
      <div className="relative">
        ...
        {/* Expand map button */}
        <Button
          className="absolute top-4 right-4 bg-white border border-gray-300 text-black hover:bg-gray-50"
        >
          Stor karta
        </Button>
