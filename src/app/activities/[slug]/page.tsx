...
import { Star, MapPin, Clock, Users, ChevronLeft, ChevronRight, Heart, Share2 } from 'lucide-react';
import { Activity } from '@/lib/types';
import { getActivityBySlug } from '@/lib/utils';
              ...
              {activeTab === 'reviews' && (
                <div className="space-y-6">
                  ...
                  {activity.ratingBreakdown && (
                    <div className="mb-8">
                      <RatingBreakdown 
                        overallRating={activity.rating} 
                        ratingBreakdown={activity.ratingBreakdown} 
                      />
                    </div>
                  )}
                  <div className="space-y-4">
